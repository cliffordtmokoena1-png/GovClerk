...
//
// Notes:
// - This uses the same bucket and region as the WhatsApp audio codepath: GovClerkMinuteswhatsapp (us-east-1).
...
async function main() {
  ...
  program
    ...
    .description(
      "Upload a local file to S3 using a presigned URL (GovClerkMinuteswhatsapp / us-east-1)."
    )
