...
export const PROFESSIONAL_FEATURES = [
  ...
  "14 day money back guarantee",
  "Annual Offer: 2 months free when billed annually",
];
...
export const PREMIUM_FEATURES = [
  ...
  "14 day money back guarantee",
  "Annual Offer: 3 months free when billed annually",
];
...
// Legacy feature lists kept for backward compatibility
export const BASIC_FEATURES = ESSENTIAL_FEATURES;
export const PRO_FEATURES = PROFESSIONAL_FEATURES;
