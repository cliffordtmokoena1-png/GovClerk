    ...
    <form onSubmit={handleSave} className="space-y-6">
      ...
      {(form.preferredPlatform === "youtube") && (
        <div className="space-y-3 p-4 bg-red-50 border border-red-200 rounded-xl">
          ...
          <div>
            ...
            <input type="text" value={form.youtubeChannelId} onChange={(e) => handleChange("youtubeChannelId", e.target.value)} placeholder="UCxxxxxxxxxxxxxx" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">Live URL</label>
            <input type="url" value={form.youtubeLiveUrl} onChange={(e) => handleChange("youtubeLiveUrl", e.target.value)} placeholder="https://www.youtube.com/watch?v=..." className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
      )}
      ...
      {form.preferredPlatform === "zoom" && (
        <div className="space-y-3 p-4 bg-blue-50 border border-blue-200 rounded-xl">
          ...
          <div>
            ...
            <input type="text" value={form.zoomWebinarId} onChange={(e) => handleChange("zoomWebinarId", e.target.value)} placeholder="123 456 7890" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">Join URL</label>
            <input type="url" value={form.zoomJoinUrl} onChange={(e) => handleChange("zoomJoinUrl", e.target.value)} placeholder="https://zoom.us/j/..." className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
      )}
      ...
      {form.preferredPlatform === "google_meet" && (
        <div className="space-y-3 p-4 bg-green-50 border border-green-200 rounded-xl">
          ...
          <div>
            ...
            <input type="url" value={form.googleMeetUrl} onChange={(e) => handleChange("googleMeetUrl", e.target.value)} placeholder="https://meet.google.com/xxx-xxxx-xxx" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
      )}
      ...
      {form.preferredPlatform === "facebook" && (
        <div className="space-y-3 p-4 bg-indigo-50 border border-indigo-200 rounded-xl">
          ...
          <div>
            ...
            <input type="text" value={form.facebookPageId} onChange={(e) => handleChange("facebookPageId", e.target.value)} placeholder="123456789" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">Live URL</label>
            <input type="url" value={form.facebookLiveUrl} onChange={(e) => handleChange("facebookLiveUrl", e.target.value)} placeholder="https://www.facebook.com/.../videos/..." className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
      )}
      ...
      {form.preferredPlatform === "rtmp" && (
        <div className="space-y-3 p-4 bg-orange-50 border border-orange-200 rounded-xl">
          ...
          <p className="text-xs text-orange-700">Provide the HLS playback URL (what viewers use — NOT the ingest stream key)</p>
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">HLS Playback URL</label>
            <input type="url" value={form.rtmpHlsUrl} onChange={(e) => handleChange("rtmpHlsUrl", e.target.value)} placeholder="https://your-server.com/stream/playlist.m3u8" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
      )}
      ...
      {form.preferredPlatform === "custom" && (
        <div className="space-y-3 p-4 bg-gray-50 border border-gray-200 rounded-xl">
          ...
          <div>
            ...
            <input type="url" value={form.customEmbedUrl} onChange={(e) => handleChange("customEmbedUrl", e.target.value)} placeholder="https://your-stream-provider.com/embed/..." className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
      )}

      {error && <p className="text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg px-3 py-2">{error}</p>}
      {saved && <p className="text-sm text-green-700 bg-green-50 border border-green-200 rounded-lg px-3 py-2">✅ Stream configuration saved!</p>}
