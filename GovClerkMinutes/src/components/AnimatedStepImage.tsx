...
const STEP_IMAGE_MAP: Record<number, string[]> = {
  0: ["/steps/step-robot-meeting.png"],   // Transcribing your meeting...
  1: ["/steps/step-robot-workshop.png"],  // Extracting key points...
  2: ["/steps/step-robot-notebook.png"],  // Drafting your minutes...
  3: ["/steps/step-robot-meeting.png"],   // Reviewing the draft...
  4: ["/steps/step-robot-notebook.png"],  // Finalizing your minutes...
};
