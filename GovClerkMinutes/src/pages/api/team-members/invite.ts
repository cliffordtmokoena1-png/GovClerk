...
async function sendInviteEmail({
  ...
  await sendEmail({
    ...
    TextBody: `You've been invited!\n\n${cleanInviterName} has invited you to collaborate on GovClerk Minutes — a platform purpose-built to help government clerks and municipal professionals produce accurate, professional meeting minutes with ease.\n\nTo accept your invitation, visit:\n${acceptUrl}\n\nYou may need to create an account or sign in first.\n\nWarm regards,\nCliff Mokoena\nFounder, GovClerk Minutes\ngovclerkminutes.com`,
